...
class Offseason(commands.Cog):
    ...
    @app_commands.command(name='register_driver', description='Register yourself as a driver')
    ...
    async def register_driver(self, msg: discord.Interaction, number: app_commands.Range[int, 2, 999], gamertag: str):
        db = mongo['RH']
